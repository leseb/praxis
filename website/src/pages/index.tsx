...
export default function Home(): React.JSX.Element {
  return (
    <Layout description="High-performance, security-first HTTP proxy and framework for AI and cloud-native workloads. Built on Pingora.">
      <main>
          ...
          <div className={styles.heroSplit}>
            <div className={styles.heroContent}>
              ...
              <p className={styles.heroSubtitle}>
                ...
                filter. Secure by default, extensible in Rust, built on Pingora.
              </p>
