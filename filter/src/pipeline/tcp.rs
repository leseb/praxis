...
impl FilterPipeline {
    ...
    #[allow(clippy::cognitive_complexity, reason = "pre-existing: TCP filter iteration with failure mode")]
    ...
    #[allow(clippy::cognitive_complexity, reason = "pre-existing: TCP disconnect filter iteration")]
