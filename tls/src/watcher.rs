...
#[allow(clippy::cognitive_complexity, reason = "event matching branches, not genuinely complex")]
...
#[allow(clippy::cognitive_complexity, reason = "match arms with logging, not genuinely complex")]
